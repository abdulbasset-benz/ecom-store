...
@section('content')
    <div class="container grid grid-cols-1 md:grid-cols-2 bg-green-300">
        ...
        <div class="p-4 rounded-lg flex flex-col bg-red-500">
            ...
            <div class="grid grid-cols-3 gap-4 mt-6">
                <!-- Quantity Control -->
                <div class="flex items-center justify-evenly gap-4 bg-gray-300 px-5 py-2 rounded-full">
                ...
                <!-- Add to Cart Button -->
                <button
                    class="bg-black text-slate-50 rounded-full col-span-2 md:col-span-1 font-bold uppercase hover:text-indigo-600 hover:bg-indigo-200">
                    Add to Cart
                </button>
            </div>
